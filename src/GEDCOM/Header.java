...
public class Header extends Parser{
    ...
    static String charset, file_id, gedcom_version, format, submitter_id;

    public Header() throws SourceException{

        System.out.println("\n ** STARTED IMPORTING HEADER at line " + getLineNumber() + "**\n");
    ...
    private static void readSubmitter() throws SourceException {
        ...
        accept(SUBM);
        accept(POINTER);
        System.out.println("Setting Submitter as " + getCurrentSpelling());
