...
public class Controller {
    ...
    @FXML Button refreshLists;
    @FXML Button makeConnection;

    @FXML ListView<String> individualsTable1;
    @FXML TableView<String> individualsTable2;
    @FXML TableView<String> familiesTable1;
    @FXML TableView<String> familiesTable2;

    @FXML TableColumn<ObservableList<String>,String> givenNameColumn1;
    @FXML TableColumn givenNameColumn2;
    @FXML TableColumn surnameColumn1;
    @FXML TableColumn surnameColumn2;
...
//        ObservableList<String> data = getColumnAsArray("given_name", "individual");
//
//        individualsTable1.setItems(data);
